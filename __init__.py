                    ...
                    if auto_send:
                        ...
                        if changes_made:
                            try:
                                ...
                                logger.info(
                                    f"Successfully auto-updated multi-field note {note.id}"
                                )
                            except Exception as e:
                                logger.exception(
                                    f"Error auto-updating multi-field note {note.id}: {e}"
                                )
                        else:
                            logger.info(
                                f"No new content to update for multi-field note {note.id}"
                            )
                    break
